...
var catalogs = map[Locale]map[string]string{
	LocaleZhCN: {
		...
		"custom.fcitx_theme.desc":                  "同步内置的 Fcitx5 主题集合，再从勾选项中选择一个设为当前主题。",
		"custom.fcitx_theme.hint":                  "Space 勾选要保留的主题，程序会同步复制或删除内置主题目录。",
		"custom.fcitx_theme.selected_count":        "已选主题: %d",
		"custom.fcitx_theme.hint.toggle":           "Space 勾选",
		"custom.fcitx_theme.hint.next":             "Enter 下一步",
		"custom.fcitx_theme.default_title":         "选择当前主题",
		"custom.fcitx_theme.default_empty":         "请先在上一步选择至少一个主题。",
		"custom.fcitx_theme.default_hint":          "从已勾选主题中选择一个作为当前 Fcitx5 主题。",
		"custom.fcitx_theme.deploy_title":          "重载 Fcitx5",
		"custom.fcitx_theme.deploy_body":           "主题 %s 已安装并设置。\n按 Enter 立即重载 Fcitx5，按其他键返回。",
		...
		"custom.result.fcitx_theme_deploy_success": "Fcitx5 主题已设置为 %s，并完成重载。",
	...
	LocaleEn: {
		...
		"custom.fcitx_theme.desc":                  "Sync bundled Fcitx5 themes, then choose one checked theme as the active theme.",
		"custom.fcitx_theme.hint":                  "Space toggles themes to keep. Bundled theme directories will be copied or removed to match.",
		...
		"custom.fcitx_theme.default_title":         "Choose Active Theme",
		"custom.fcitx_theme.default_empty":         "Select at least one theme in the previous step first.",
		"custom.fcitx_theme.default_hint":          "Choose one checked theme as the active Fcitx5 theme.",
		"custom.fcitx_theme.deploy_title":          "Reload Fcitx5",
		"custom.fcitx_theme.deploy_body":           "Theme %s has been installed and selected.\nPress Enter to reload Fcitx5 now, or press any other key to return.",
		...
		"custom.result.fcitx_theme_deploy_success": "Fcitx5 theme set to %s and reload completed.",
